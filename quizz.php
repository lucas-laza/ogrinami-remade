...
if (isset($_GET["id"])){
    ...
    if ($idQ != 0){
        ...
        if ($result["Fin"] == 0){
            ...
            <div class="quizz_container">
                <div class="quizz">
                    ...
                    <div class="reponses">
                        <a href="quizz.php?id=<?php echo $id . "&q=" .$result["ext_id_Q_R1"]?>"><div class="rep r1"><?php if ($_SESSION["lang"] == "FR"){echo $result["Q_texte_R1_FR"];} else if ($_SESSION["lang"] == "EN"){echo $result["Q_texte_R1_EN"];}?></div></a>
                        <a href="quizz.php?id=<?php echo $id . "&q=" .$result["ext_id_Q_R2"]?>"><div class="rep r2"><?php if ($_SESSION["lang"] == "FR"){echo $result["Q_texte_R2_FR"];} else if ($_SESSION["lang"] == "EN"){echo $result["Q_texte_R2_EN"];}?></div></a>
                    </div>
                </div>
            </div>
            <?php } else {
            ...
            <div class="finquizz">
                ...
                <a href="quizz.php?id=<?php echo $result["ext_id_quizz"] . "&q=0" ?>"><div class="rep r2"><?php if ($_SESSION["lang"] == "FR"){echo "Recommencer le quizz !";} else if ($_SESSION["lang"] == "EN"){echo "Retake the quizz !";}?></div></a></div>
        ...
        <div class="quizzstart_container">
            <div class="quizzstart">
                ...
                <div class="qs_img"><a href="quizz.php?id=<?php echo $id . "&q=" . $idFQ ?>"><div class="rep r2"><?php if ($_SESSION["lang"] == "FR"){echo "Faire le quizz !";} else if ($_SESSION["lang"] == "EN"){echo "Take the quizz !";}?></div></a></div>
            </div>
        </div>
